# Carta — Backend developer guide

> This is the original developer guide for the FastAPI backend skeleton (April 2026), moved here from the main README. Where it conflicts with [`docs/mvp/`](mvp/README.md) (August 2026), `docs/mvp/` wins: for example, the diner client is a PWA ([ADR-002](mvp/adr/ADR-002-pwa-vs-nativa.md)), and the backend does not start until task T-0.1 of the [implementation plan](mvp/06_Implementation_Plan.md) is done. Setup details live in [`SETUP.md`](../SETUP.md).
